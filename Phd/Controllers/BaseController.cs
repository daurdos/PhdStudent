...
namespace Phd.Controllers
{
    public class BaseController : Controller
    {
        ...
        public bool IsAdmin()
        {
            return HttpContext.User.IsAdmin(); // Вызывать методы расширения. Как делал Жангельды
        }


        //пример как сделать булевове свойство возвращающее три фолс при определенных условиях
